...
{
    "distutils": {
        "name": "dishka.entities.validation_settigs",
        "sources": [
            "src\\dishka\\entities\\validation_settigs.py"
        ]
    },
    "module_name": "dishka.entities.validation_settigs"
}
END: Cython Metadata */
...
#define __PYX_HAVE__dishka__entities__validation_settigs
#define __PYX_HAVE_API__dishka__entities__validation_settigs
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "dishka.entities.validation_settigs" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "dishka.entities.validation_settigs"
extern int __pyx_module_is_main_dishka__entities__validation_settigs;
int __pyx_module_is_main_dishka__entities__validation_settigs = 0;

/* Implementation of "dishka.entities.validation_settigs" */
...
#define __pyx_kp_u_dishka_entities_validation_sett __pyx_string_tab[2]
#define __pyx_n_u_DEFAULT_VALIDATION __pyx_string_tab[3]
#define __pyx_n_u_STRICT_VALIDATION __pyx_string_tab[4]
#define __pyx_n_u_ValidationSettings __pyx_string_tab[5]
#define __pyx_n_u_all __pyx_string_tab[6]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[7]
#define __pyx_n_u_dishka_entities_validation_setti __pyx_string_tab[8]
...
#define __pyx_n_u_stacklevel __pyx_string_tab[14]
#define __pyx_n_u_test __pyx_string_tab[15]
#define __pyx_n_u_warn __pyx_string_tab[16]
#define __pyx_n_u_warnings __pyx_string_tab[17]
...
static int __pyx_pymod_exec_validation_settigs(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_validation_settigs},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_validation_settigs(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_validation_settigs(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_validation_settigs(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'validation_settigs' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "validation_settigs" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_validation_settigs", 0);
  ...
  if (__pyx_module_is_main_dishka__entities__validation_settigs) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "dishka.entities.validation_settigs")) {
      if (unlikely((PyDict_SetItemString(modules, "dishka.entities.validation_settigs", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "dishka/entities/validation_settigs.py":1
 * import warnings             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  /* "dishka/entities/validation_settigs.py":3
 * import warnings
 * 
 * from dishka.entities.validation_settings import (             # <<<<<<<<<<<<<<
 *     DEFAULT_VALIDATION,
...
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_DEFAULT_VALIDATION,__pyx_mstate_global->__pyx_n_u_STRICT_VALIDATION,__pyx_mstate_global->__pyx_n_u_ValidationSettings};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_dishka_entities_validation_setti, __pyx_imported_names, 3, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 3, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  {
  ...
  /* "dishka/entities/validation_settigs.py":9
 * )
 * 
 * warnings.warn(             # <<<<<<<<<<<<<<
...
*/
  ...
  /* "dishka/entities/validation_settigs.py":13
 *     " is deprecated and will be removed in 2.0"
...
*/
  __pyx_t_7 = 1;
  {
    PyObject *__pyx_callargs[3 + ((CYTHON_VECTORCALL) ? 1 : 0)] = {__pyx_t_4, __pyx_mstate_global->__pyx_kp_u_dishka_entities_validation_sett, ((PyObject *)(((PyTypeObject*)PyExc_DeprecationWarning)))};
  ...
  /* "dishka/entities/validation_settigs.py":17
 * )
 * 
 * __all__ = [             # <<<<<<<<<<<<<<
 *     "DEFAULT_VALIDATION",
 *     "STRICT_VALIDATION",
*/
  __pyx_t_2 = __Pyx_PyList_Pack(3, __pyx_mstate_global->__pyx_n_u_DEFAULT_VALIDATION, __pyx_mstate_global->__pyx_n_u_STRICT_VALIDATION, __pyx_mstate_global->__pyx_n_u_ValidationSettings); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init dishka.entities.validation_settigs", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init dishka.entities.validation_settigs");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 7; } index[] = {{1},{1},{116},{18},{17},{18},{7},{18},{35},{8},{10},{8},{12},{10},{10},{8},{4},{8}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (262 bytes) */
const char* const cstring = "BZh91AY&SY\340\340\305L\000\000\n\337\200@\000@\005P\000\257%\237\000\377\357\377\2000\000\315X4\215M#\324\364i\032yO@\310\203#\324\3204T\374\215OT\321\350\206#CA\240i\200\305$\375\022m\020zF\232\031\250\000\032<\247\3521\363=eD\2055\033km\234\224k\006\022\244H8v\201Pp\306\361\021x\224Fq\233\033\336'L\350\300=\030\004\014/\026\361Nv\014(A\202JO\235\336\017\316\225U\246\033\212\267hg\341\256\205\263\024\216\344\264\216'2m#k~\277\254\034\030\276oK\255A\300\036\220\321\030\250\313Uf\014X\300\355\220\267cR\360\310\252\313\207\323\254<Y\272\350\226\320\340\266mA\376h\210\031\203G\202\001Q\304j\260\320\262@\255%\246al\357\223\203)H\224\227_\tV\024\347f\014HL\026\226,\353\215\026\212\"\357\r\005\334\221N\024$881S\000";
    PyObject *data = __Pyx_DecompressString(cstring, 262, 2);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (206 bytes) */
const char* const cstring = "x\332\205OAj\303@\014\374\212\036P\226\320\017\024\323\264`\010-$N\256\262\342UR\021\255\234\356\312\316\367\273N\240\364V\201\3200hF\243\360\322G)_\027\nl..\\\302L*\221\\F\303\302\356r.=H\201\310\327\314\0039G \213p\023U82dN\343\\91x\016\253'\230\nC\177\312c\202\207/H\272\216\331!\204Pm\2548S\014\353\267\367f\277\351\360\320l\332u\323\265\237\037\273n\333\276\376%\016\277)vK\010;\027DRE\034T\214Q\014=\323\300G\032.\377=p\327&\252\222Zi\214\223\362\202\214\322}~O\244\017\\\267#\237hR/^}\225g\256\007\235\213#\336(\333\322\213\333\017\t\251t\003";
    PyObject *data = __Pyx_DecompressString(cstring, 206, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (309 bytes) */
const char* const bytes = ".?`dishka.entities.validation_settigs` is deprecated and will be removed in 2.0, use `from dishka import ...` instead.DEFAULT_VALIDATIONSTRICT_VALIDATIONValidationSettings__all__cline_in_tracebackdishka.entities.validation_settings__main____module____name____qualname__setdefaultstacklevel__test__warnwarnings";
    PyObject *data = NULL;
