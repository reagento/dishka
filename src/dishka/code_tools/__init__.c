...
{
    "distutils": {
        "name": "dishka.code_tools.__init__",
        "sources": [
            "src\\dishka\\code_tools\\__init__.py"
        ]
    },
    "module_name": "dishka.code_tools.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__dishka__code_tools
#define __PYX_HAVE_API__dishka__code_tools
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "dishka.code_tools" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "dishka.code_tools.__init__"
extern int __pyx_module_is_main_dishka__code_tools____init__;
int __pyx_module_is_main_dishka__code_tools____init__ = 0;

/* Implementation of "dishka.code_tools" */
...
#define __pyx_kp_u_dishka_code_tools___init __pyx_string_tab[1]
...
static int __pyx_pymod_exec_code_tools(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_code_tools},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_code_tools(void) CYTHON_SMALL_CODE; /*proto*/
#if !defined(CYTHON_NO_PYINIT_EXPORT) && (defined(_WIN32) || defined(WIN32) || defined(MS_WINDOWS))
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_code_tools(); }
#endif
__Pyx_PyMODINIT_FUNC PyInit_code_tools(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_code_tools(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'code_tools' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "code_tools" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_code_tools", 0);
  ...
  if (__pyx_module_is_main_dishka__code_tools____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_dishka_code_tools___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "dishka.code_tools")) {
      if (unlikely((PyDict_SetItemString(modules, "dishka.code_tools", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "dishka/code_tools/__init__.py":1
             # <<<<<<<<<<<<<<
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init dishka.code_tools", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init dishka.code_tools");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{26},{18},{8},{10},{8},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (82 bytes) */
const char* const cstring = "x\332%\214\301\021\2000\010\004;J\013\226\302 \340\310\204\204QH\377\242\336co\357s\033k\234\035\0339\013\244\273E\003\320\251\t@\246S\312!o$\331\221:\300\300\332\225\341\274L^\2338\276\276\026\332\357!\311r\340\262\372H\211\342\003\351\313((";
    ...
    #endif
    #else /* compression: none (101 bytes) */
const char* const bytes = "?dishka.code_tools.__init__cline_in_traceback__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
