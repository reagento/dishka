...
{
    "distutils": {
        "name": "dishka.integrations.__init__",
        "sources": [
            "src\\dishka\\integrations\\__init__.py"
        ]
    },
    "module_name": "dishka.integrations.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__dishka__integrations
#define __PYX_HAVE_API__dishka__integrations
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "dishka.integrations" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "dishka.integrations.__init__"
extern int __pyx_module_is_main_dishka__integrations____init__;
int __pyx_module_is_main_dishka__integrations____init__ = 0;

/* Implementation of "dishka.integrations" */
...
#define __pyx_kp_u_dishka_integrations___init __pyx_string_tab[1]
...
static int __pyx_pymod_exec_integrations(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_integrations},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_integrations(void) CYTHON_SMALL_CODE; /*proto*/
#if !defined(CYTHON_NO_PYINIT_EXPORT) && (defined(_WIN32) || defined(WIN32) || defined(MS_WINDOWS))
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_integrations(); }
#endif
__Pyx_PyMODINIT_FUNC PyInit_integrations(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_integrations(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'integrations' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "integrations" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_integrations", 0);
  ...
  if (__pyx_module_is_main_dishka__integrations____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_mstate_global->__pyx_kp_u_dishka_integrations___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "dishka.integrations")) {
      if (unlikely((PyDict_SetItemString(modules, "dishka.integrations", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "dishka/integrations/__init__.py":1
             # <<<<<<<<<<<<<<
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init dishka.integrations", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init dishka.integrations");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    ...
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (83 bytes) */
const char* const cstring = "x\332%\214A\022\200 \014\003\177\304\027|J'B\325\016PFZ\376o\325\0346\233K\266\"vU$Q\347s\302e\250%\"Qq\242\334D9\234|\"\363\216\\\211:bG\372(\253\361k\212\376\365\275\320~7\366\302\007V\213\017g\013>F\203)\024";
    PyObject *data = __Pyx_DecompressString(cstring, 83, 1);
...
const char* const bytes = "?dishka.integrations.__init__cline_in_traceback__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
