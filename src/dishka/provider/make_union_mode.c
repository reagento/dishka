...
{
    "distutils": {
        "name": "dishka.provider.make_union_mode",
        "sources": [
            "src\\dishka\\provider\\make_union_mode.py"
        ]
    },
    "module_name": "dishka.provider.make_union_mode"
}
END: Cython Metadata */
...
#define __PYX_HAVE__dishka__provider__make_union_mode
#define __PYX_HAVE_API__dishka__provider__make_union_mode
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "dishka.provider.make_union_mode" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "dishka.provider.make_union_mode"
extern int __pyx_module_is_main_dishka__provider__make_union_mode;
int __pyx_module_is_main_dishka__provider__make_union_mode = 0;

/* Implementation of "dishka.provider.make_union_mode" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_6dishka_8provider_15make_union_mode_collect(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_source, PyObject *__pyx_v_scope, int __pyx_v_cache, PyObject *__pyx_v_provides); /* proto */
...
#define __pyx_kp_u_src_dishka_provider_make_union_m __pyx_string_tab[3]
#define __pyx_n_u_Any __pyx_string_tab[4]
#define __pyx_n_u_BaseScope __pyx_string_tab[5]
#define __pyx_n_u_CompositeDependencySource __pyx_string_tab[6]
#define __pyx_n_u_FactoryUnionMode __pyx_string_tab[7]
...
#define __pyx_n_u_cache __pyx_string_tab[12]
#define __pyx_n_u_class_getitem __pyx_string_tab[13]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[14]
#define __pyx_n_u_collect __pyx_string_tab[15]
#define __pyx_n_u_dependency_sources __pyx_string_tab[16]
#define __pyx_n_u_dishka_dependency_source __pyx_string_tab[17]
#define __pyx_n_u_dishka_entities_key __pyx_string_tab[18]
#define __pyx_n_u_dishka_entities_scope __pyx_string_tab[19]
#define __pyx_n_u_dishka_provider_make_union_mode __pyx_string_tab[20]
#define __pyx_n_u_func __pyx_string_tab[21]
#define __pyx_n_u_hint_to_dependency_key __pyx_string_tab[22]
...
#define __pyx_n_u_provides __pyx_string_tab[30]
#define __pyx_n_u_provides_key __pyx_string_tab[31]
#define __pyx_n_u_qualname __pyx_string_tab[32]
#define __pyx_n_u_return __pyx_string_tab[33]
#define __pyx_n_u_scope __pyx_string_tab[34]
#define __pyx_n_u_set_name __pyx_string_tab[35]
#define __pyx_n_u_setdefault __pyx_string_tab[36]
#define __pyx_n_u_source __pyx_string_tab[37]
#define __pyx_n_u_src __pyx_string_tab[38]
#define __pyx_n_u_test __pyx_string_tab[39]
#define __pyx_n_u_type_hint __pyx_string_tab[40]
#define __pyx_n_u_typing __pyx_string_tab[41]
#define __pyx_n_u_values __pyx_string_tab[42]
#define __pyx_kp_b_iso88591_1_1_a_1A_y_1_4q_1_2_q_a_a_1 __pyx_string_tab[43]
...
/* "dishka/provider/make_union_mode.py":11
 * 
 * 
 * def collect(             # <<<<<<<<<<<<<<
 *     source: Any,
...
/* Python wrapper */
static PyObject *__pyx_pw_6dishka_8provider_15make_union_mode_1collect(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_6dishka_8provider_15make_union_mode_1collect = {"collect", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_6dishka_8provider_15make_union_mode_1collect, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6dishka_8provider_15make_union_mode_1collect(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_source,&__pyx_mstate_global->__pyx_n_u_scope,&__pyx_mstate_global->__pyx_n_u_cache,&__pyx_mstate_global->__pyx_n_u_provides,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "collect", 0) < (0)) __PYX_ERR(0, 11, __pyx_L3_error)

      /* "dishka/provider/make_union_mode.py":14
 *     source: Any,
 *     *,
...
*/
      ...
      /* "dishka/provider/make_union_mode.py":16
 *     scope: BaseScope | None = None,
 *     cache: bool = True,
 *     provides: Any = None,             # <<<<<<<<<<<<<<
...
*/
      ...
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("collect", 1, 1, 1, i); __PYX_ERR(0, 11, __pyx_L3_error) }
      }
...
*/
    ...
    if (values[2]) {
      __pyx_v_cache = __Pyx_PyObject_IsTrue(values[2]); if (unlikely((__pyx_v_cache == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L3_error)
    } else {

      /* "dishka/provider/make_union_mode.py":15
 *     *,
 *     scope: BaseScope | None = None,
 *     cache: bool = True,             # <<<<<<<<<<<<<<
 *     provides: Any = None,
...
*/
  ...
  __Pyx_RaiseArgtupleInvalid("collect", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 11, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("dishka.provider.make_union_mode.collect", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_6dishka_8provider_15make_union_mode_collect(__pyx_self, __pyx_v_source, __pyx_v_scope, __pyx_v_cache, __pyx_v_provides);
...
static PyObject *__pyx_pf_6dishka_8provider_15make_union_mode_collect(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_source, PyObject *__pyx_v_scope, int __pyx_v_cache, PyObject *__pyx_v_provides) {
  PyObject *__pyx_v_src = NULL;
  PyObject *__pyx_v_key = NULL;
  PyObject *__pyx_v_provides_key = NULL;
  ...
  /* "dishka/provider/make_union_mode.py":18
 *     provides: Any = None,
 * ) -> CompositeDependencySource:
 *     src = CompositeDependencySource(source)             # <<<<<<<<<<<<<<
...
*/
  __pyx_t_2 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_CompositeDependencySource); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 18, __pyx_L1_error)
  ...
  /* "dishka/provider/make_union_mode.py":19
 * ) -> CompositeDependencySource:
 *     src = CompositeDependencySource(source)
 *     key = hint_to_dependency_key(source)             # <<<<<<<<<<<<<<
 *     if provides is None:
...
*/
  __pyx_t_3 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_hint_to_dependency_key); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 19, __pyx_L1_error)
  ...
  /* "dishka/provider/make_union_mode.py":20
 *     src = CompositeDependencySource(source)
 *     key = hint_to_dependency_key(source)
 *     if provides is None:             # <<<<<<<<<<<<<<
 *         provides = list[key.type_hint]  # type: ignore[name-defined]
...
*/
  __pyx_t_5 = (__pyx_v_provides == Py_None);
  if (__pyx_t_5) {

    /* "dishka/provider/make_union_mode.py":21
 *     key = hint_to_dependency_key(source)
 *     if provides is None:
 *         provides = list[key.type_hint]  # type: ignore[name-defined]             # <<<<<<<<<<<<<<
 *     provides_key = hint_to_dependency_key(provides)
...
*/
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_key, __pyx_mstate_global->__pyx_n_u_type_hint); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 21, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = __Pyx_PyObject_GetItem(((PyObject *)(&PyList_Type)), __pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 21, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
...
*/
  ...
  /* "dishka/provider/make_union_mode.py":22
 *     if provides is None:
 *         provides = list[key.type_hint]  # type: ignore[name-defined]
 *     provides_key = hint_to_dependency_key(provides)             # <<<<<<<<<<<<<<
 *     src.dependency_sources.append(FactoryUnionMode(
...
*/
  __pyx_t_1 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_hint_to_dependency_key); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = 1;
  #if CYTHON_UNPACK_METHODS
  if (unlikely(PyMethod_Check(__pyx_t_3))) {
  ...
  __pyx_v_provides_key = __pyx_t_2;
  __pyx_t_2 = 0;

  /* "dishka/provider/make_union_mode.py":23
 *         provides = list[key.type_hint]  # type: ignore[name-defined]
 *     provides_key = hint_to_dependency_key(provides)
 *     src.dependency_sources.append(FactoryUnionMode(             # <<<<<<<<<<<<<<
 *         source=key,
 *         collect=True,
*/
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_src, __pyx_mstate_global->__pyx_n_u_dependency_sources); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_1 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_FactoryUnionMode); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);

  /* "dishka/provider/make_union_mode.py":26
 *         source=key,
 *         collect=True,
 *         cache=cache,             # <<<<<<<<<<<<<<
 *         scope=scope,
...
*/
  __pyx_t_7 = __Pyx_PyBool_FromLong(__pyx_v_cache); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);

  /* "dishka/provider/make_union_mode.py":28
 *         cache=cache,
 *         scope=scope,
 *         provides=provides_key,             # <<<<<<<<<<<<<<
 *     ))
...
*/
  ...
  #endif
  {
    ...
    __pyx_t_8 = __Pyx_MakeVectorcallBuilderKwds(5); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 23, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_source, __pyx_v_key, __pyx_t_8, __pyx_callargs+1, 0) < (0)) __PYX_ERR(0, 23, __pyx_L1_error)
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_collect, Py_True, __pyx_t_8, __pyx_callargs+1, 1) < (0)) __PYX_ERR(0, 23, __pyx_L1_error)
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_cache, __pyx_t_7, __pyx_t_8, __pyx_callargs+1, 2) < (0)) __PYX_ERR(0, 23, __pyx_L1_error)
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_scope, __pyx_v_scope, __pyx_t_8, __pyx_callargs+1, 3) < (0)) __PYX_ERR(0, 23, __pyx_L1_error)
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_provides, __pyx_v_provides_key, __pyx_t_8, __pyx_callargs+1, 4) < (0)) __PYX_ERR(0, 23, __pyx_L1_error)
    __pyx_t_3 = __Pyx_Object_Vectorcall_CallFromBuilder((PyObject*)__pyx_t_6, __pyx_callargs+__pyx_t_4, (1-__pyx_t_4) | (__pyx_t_4*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET), __pyx_t_8);
    __Pyx_XDECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *         collect=True,
*/
  __pyx_t_9 = __Pyx_PyObject_Append(__pyx_t_2, __pyx_t_3); if (unlikely(__pyx_t_9 == ((int)-1))) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

  /* "dishka/provider/make_union_mode.py":30
 *         provides=provides_key,
 *     ))
 *     return src             # <<<<<<<<<<<<<<
*/
...
*/
  ...
  __Pyx_XDECREF(__pyx_v_provides_key);
...
static int __pyx_pymod_exec_make_union_mode(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_make_union_mode},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_make_union_mode(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_make_union_mode(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_make_union_mode(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'make_union_mode' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "make_union_mode" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_make_union_mode", 0);
  ...
  if (__pyx_module_is_main_dishka__provider__make_union_mode) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "dishka.provider.make_union_mode")) {
      if (unlikely((PyDict_SetItemString(modules, "dishka.provider.make_union_mode", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "dishka/provider/make_union_mode.py":1
...
*/
  ...
  /* "dishka/provider/make_union_mode.py":3
 * from typing import Any
 * 
 * from dishka.dependency_source import (             # <<<<<<<<<<<<<<
 *     CompositeDependencySource,
...
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_CompositeDependencySource,__pyx_mstate_global->__pyx_n_u_FactoryUnionMode};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_dishka_dependency_source, __pyx_imported_names, 2, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 3, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  {
  ...
  /* "dishka/provider/make_union_mode.py":7
 *     FactoryUnionMode,
 * )
...
*/
  ...
  /* "dishka/provider/make_union_mode.py":8
 * )
 * from dishka.entities.key import hint_to_dependency_key
 * from dishka.entities.scope import BaseScope             # <<<<<<<<<<<<<<
 * 
...
*/
  {
    ...
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_dishka_entities_scope, __pyx_imported_names, 1, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  {
 ...
 *     provides: Any = None,
*/
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_scope, Py_None) < (0)) __PYX_ERR(0, 11, __pyx_L1_error)
 ...
 * ) -> CompositeDependencySource:
*/
  __pyx_t_4 = __Pyx_PyBool_FromLong(((int)1)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_cache, __pyx_t_4) < (0)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 *     src = CompositeDependencySource(source)
*/
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_provides, Py_None) < (0)) __PYX_ERR(0, 11, __pyx_L1_error)
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_source, __pyx_mstate_global->__pyx_n_u_Any) < (0)) __PYX_ERR(0, 11, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_scope, __pyx_mstate_global->__pyx_kp_u_BaseScope_None) < (0)) __PYX_ERR(0, 11, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_cache, __pyx_mstate_global->__pyx_n_u_bool) < (0)) __PYX_ERR(0, 11, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_provides, __pyx_mstate_global->__pyx_n_u_Any) < (0)) __PYX_ERR(0, 11, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_return, __pyx_mstate_global->__pyx_n_u_CompositeDependencySource) < (0)) __PYX_ERR(0, 11, __pyx_L1_error)
  __pyx_t_5 = __Pyx_CyFunction_New(&__pyx_mdef_6dishka_8provider_15make_union_mode_1collect, 0, __pyx_mstate_global->__pyx_n_u_collect, NULL, __pyx_mstate_global->__pyx_n_u_dishka_provider_make_union_mode, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 11, __pyx_L1_error)
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_collect, __pyx_t_5) < (0)) __PYX_ERR(0, 11, __pyx_L1_error)
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init dishka.provider.make_union_mode", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init dishka.provider.make_union_mode");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 7; } index[] = {{1},{16},{1},{38},{3},{9},{25},{16},{20},{6},{18},{4},{5},{17},{18},{7},{18},{24},{19},{21},{31},{8},{22},{13},{5},{3},{8},{10},{8},{3},{8},{12},{12},{6},{5},{12},{10},{6},{3},{8},{9},{6},{6},{118}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (466 bytes) */
const char* const cstring = "BZh91AY&SY\262\266\243\376\000\000\035\377\373o\337\350\020x\241\264\000\275\003Z\000\277\357\377d@@@@@@@\000@@@\0000\001\230\033i\206\212bF5=FA\251\352z\0044\300\002b`#\010\036\236\250DS\332S\375Tz\2004h\031\000\000\003 \000\000\001((\302jOSb\223\3054\365\0002h\000\014\215\006\207\351O2\247A\273\037\352\356\3103\024)\236\201\304a\220k\333J\031P\2625Ww\017\247$\363\223\361\355\346\354\371\2468\265\037\353UY\340\245\230s\254\363\207\245\234U\307\273\320\246\372\212\307\0376J\224\203\037\345\323\026UF\214\013\257fZ\310:\274\2102\016+;VnC\t\366}\264&Y\330\230\365\2347?*[}\262X\257qQ]n.\304\210\3738Y\031!\25550F/\020\224\265\257\\\362\276\215>\334\312\356\311\266\021U\225\344\242\265o\214,\030*CI\213\241p\260\223,ym2\327\277\2149\rE,